...
class CmdVel(Node):
    def __init__(self):
        ...
        self.cmd_vel_publisher = self.create_publisher(TwistStamped, '/iris2/setpoint_velocity/cmd_vel', 10)
        
        # subscriber
        self.cmd_subscriber = self.create_subscription(String, 'p2/copter2_cmd', self.cmd_listener,10)
